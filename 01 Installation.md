...
![[Images/Pasted image 20260410082332.png]]

### Sunny Day Scenario

Link : `http://localhost:3000/#/`
![[Images/Pasted image 20260410084803.png]]

Pages
- Accessible Without Login
	1. `localhost/#/contact`
		![[Images/Pasted image 20260410084823.png]]
	2. `localhost:3000/#/about`
		![[Images/Pasted image 20260410084841.png]]
	3. `localhost:3000/#/photo-wall`
		![[Images/Pasted image 20260410084858.png]]
	4. `localhost:3000/#/login`
		![[Images/Pasted image 20260410084917.png]]
	5. `localhost:3000/#/register`
		![[Images/Pasted image 20260410084932.png]]
- Accessible After Login
	1. `localhost:3000/#/` 
		![[Images/Pasted image 20260410085115.png]]
	2. `localhost:3000/#/complain`
		![[Images/Pasted image 20260410085211.png]]
	3. `localhost:3000/#/chatbot`
		![[Images/Pasted image 20260410085250.png]]
	4. `localhost:3000/#/deluxe-membership`
		![[Images/Pasted image 20260410085338.png]]
	5. `localhost:3000/#/basket`
		![[Images/Pasted image 20260410085431.png]]
...
![[Images/Pasted image 20260410090150.png]]
	- In About Us there is link embed which leads to `localhost:3000/#/ftp/legal.md`. Giving us the flag. It can be accessed other way too, there is a `localhost:3000/robots.txt` page that is made generally for web crawlers, and there the `localhost:3000/ftp` endpoint is noted. we can directly go to `localhost:3000/ftp` giving us many more files.
		![[Images/Pasted image 20260410091551.png]]
		![[Images/Pasted image 20260410091814.png]]
